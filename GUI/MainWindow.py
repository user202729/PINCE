...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeView_AddressTable = QtWidgets.QTreeView(self.centralwidget)
        self.treeView_AddressTable.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.treeView_AddressTable.setDragDropMode(QtWidgets.QAbstractItemView.DragDrop)
        self.treeView_AddressTable.setDefaultDropAction(QtCore.Qt.MoveAction)
        self.treeView_AddressTable.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.treeView_AddressTable.setExpandsOnDoubleClick(False)
        self.treeView_AddressTable.setObjectName("treeView_AddressTable")
        self.verticalLayout_6.addWidget(self.treeView_AddressTable)
